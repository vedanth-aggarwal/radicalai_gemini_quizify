...
# https://www.youtube.com/watch?v=zizonToFXDs&t=319s
class QuizGenerator:
    ...
    def validate_question(self, question: dict) -> bool:
        ...
        if 'question' not in question:
            return False  # If 'question' key is missing, consider it invalid
        
        text = question['question']
        
        for existing_question in self.question_bank:
            if existing_question['question'] == text:
                return False  # Found a duplicate question text
